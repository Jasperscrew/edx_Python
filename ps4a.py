    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while handSize > 0:
        ...
        if userInput == '.':
            ...
            return ('Goodbye! Total score: ', totalScore, 'points')
            break
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print('\"' ,userInput,'\" earned', turnScore, 'points. Total:', totalScore, 'points')
                print()
                # Update the hand
                hand = updateHand(hand, userInput)
                handSize = calculateHandlen(hand)
    # remove the parentheses from this print statement, really annoying
    return 'Run out of letters,', totalScore, 'points'
